    ...
    <div className="app">
      ...
      <main>
        <section id="home" className="hero section home-landing">
          ...
          <div className="container home-panel">
            <div className="home-left">
              ...
              <p className="home-description">Building reliable software and meaningful digital experiences with Java, Spring Boot, React, MySQL, and an engineering mindset.</p>
        ...
        <section id="skills" className="section tinted">
          <div className="container">
            <div className="section-heading"><span>02 / SKILLS</span><h2>Technical skills,<br/><em>clearly organized.</em></h2></div>
            ...
            <div className="projects">
              {projects.map(p => (
                <article className={`project ${p.number === "01" ? "featured" : ""}`} key={p.number}>
                  ...
                  <div className="project-bottom">{p.stack.map(s => <span key={s}>{s}</span>)}</div>
                </article>
              ))}
            </div>
        ...
        <section id="contact" className="contact section">
          <div className="container contact-inner">
            <div className="contact-left">
              ...
              <h2>Let’s build<br/>something<br/><em>meaningful.</em></h2>
              <p>I am currently looking for entry-level software development opportunities. If you need a motivated developer who enjoys learning and building practical applications, I would love to connect.</p>

              <div className="contact-links">
                <a className="contact-link" href={`mailto:${email}`}>
                  <span className="contact-link-icon"><Mail size={17}/></span>
                  <span className="contact-link-copy"><small>EMAIL</small><strong>{email}</strong></span>
                  <ArrowUpRight size={17}/>
                </a>
                <a className="contact-link" href={linkedinUrl} target="_blank" rel="noopener noreferrer">
                  <span className="contact-link-icon"><Linkedin size={17}/></span>
                  <span className="contact-link-copy"><small>LINKEDIN</small><strong>Connect on LinkedIn</strong></span>
                  <ArrowUpRight size={17}/>
                </a>
                <a className="contact-link" href={githubUrl} target="_blank" rel="noopener noreferrer">
                  <span className="contact-link-icon"><Github size={17}/></span>
                  <span className="contact-link-copy"><small>GITHUB</small><strong>View my GitHub profile</strong></span>
                  <ArrowUpRight size={17}/>
                </a>
              </div>
            </div>
            ...
            <form className="contact-form" onSubmit={(e) => {
              ...
              const subject = `Software Developer Opportunity — ${name}`;
              const body = `Name: ${name}\nEmail: ${sender}\n\nMessage:\n${message}`;
              window.location.href = `mailto:${email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
            }}>
              <div className="contact-form-top"><span>START A CONVERSATION</span><b>05 / 05</b></div>
              <div className="contact-fields">
                ...
                <label className="message-field"><span>Message</span><textarea name="message" rows="7" placeholder="Tell me about the opportunity..." required /></label>
              </div>
              <div className="contact-form-bottom">
                <button className="primary-btn contact-submit" type="submit">Send message <ArrowUpRight size={18}/></button>
